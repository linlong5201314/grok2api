...
const LOCALE_MAP = {
  ...
  "token": {
    ...
    "upstream_fail_threshold": { title: "上游异常熔断阈值", desc: "单个 Token 遇到 5xx / 非标准上游失败多少次后直接禁用。" },
    "upstream_fail_cooldown_sec": { title: "上游异常降级时长", desc: "单个 Token 遇到 5xx / 非标准上游失败后的临时降级时长（秒）。" },
